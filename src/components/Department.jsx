...
function Departments() {
    return (
        <div id="Departments" className="px-2 py-10 lg:py-10 lg:h-screen overflow-y-hidden">
            {/* Background glow effect for heading */}
            ...
            <hr className="ml-[8%] w-[19%] md:w-[14%] lg:w-[16%] xl:w-[11%] mt-5 h-1 rounded-lg border-0 bg-[#0073AE]" />
